...
ventana = tk.Tk()
ventana.title("Fondo de Imagen en Text")
...
area_texto = tk.Text(canvas, height=20, width=80,borderwidth=0,relief="flat",wrap=tk.WORD,  bg="SystemButtonFace",font=("Times New Roman", 16, "italic"))
