        ...
        case 2:
            match value:
                case '0':
                    ...
                    response+="¿Que quieres hacer?: "
                    response+="A. No ver el diario"
                    response+="B. Ver el diario"
                case '1':
        ...
        case 5:
            match value:
                case '0':
                    ...
                    response = "La abrazas con fuerza, y le prometes que superarán esto juntos. Le pides perdón por haberte ausentado, y, a punto de romper en llanto, juras materializar la bondad que hacía especial a tu hija. Los años pasaron, y aprendieron a recordarla con cariño, la policía nunca encontró nada. END"
                    response+="¿Que quieres hacer?: "
                    response+="A. Elegir otro camino."
                    response+="B. Salir." 
                case '1':
        ...
        case 6:
            match value:
                ...
                case '1':
                    ...
                    response+="¿Que quieres hacer?: "
                    response+="A. Hablar de Culpa."
                    response+="B. Hablar de Odio." 
                case '2':
                    ...
                    response+="¿Que quieres hacer?: "
                    response+="A. Qudarse en casa."
                    response+="B. Ir a un bar." 
                case '3':
                    ...
                    response+="¿Que quieres hacer?: "
                    response+="A. Intentar escapar."
                    response+="B. Buscar una salida." 
                case '4':
                    ...
                    response+="¿Que quieres hacer?: "
                    response+="A. Lastimar a la esposa."
                    response+="B. Soltarla." 
                case '5':
                    ...
                    response+="¿Que quieres hacer?: "
                    response+="A. Atacar con el lapicero."
                    response+="B. Atacar con la botella." 
                case '6':
                    ...
                    response+="¿Que quieres hacer?: "
                    response+="A. Hablar de justicia."
                    response+="B. Amenazarles." 
                case '7':
                    #Te rindes: 0dd66
                ...
                case 'c':
                    ...
                    response+="¿Que quieres hacer?: "
                    response+="A. Entregarlo a la policía."
                    response+="B. Matar a #$%." 
                case 'd':
                ...
                case 'f':
                    ...
                    response+="¿Que quieres hacer?: "
                    response+="A. Entregar a #$% a la policía."
                    response+="B. Terminar con él." 
                case 'g':
                ...
                case 'i':
                    ...
                    response+="¿Que quieres hacer?: "
                    response+="A. Sacarle las respuestas a la fuerza."
                    response+="B. Parar." 
                case 'j':
                    ...
                    response +="(Tusangre hierve con cada palabra que sale de la boca de ese bastardo, ves que en la mesa hay un maletín con una gran cantidad de dinero, y aunque no sabes si el arma está cargada o no, averiguarlo podría ser mortal. ¿Sucumbes ante el miedo y aceptas el soborno, o te rehúsas?)"
                    response+="¿Que quieres hacer?: "
                    response+="A. Aceptar soborno."
                    response+="B. Rehusarse." 
        case 7:
            match value:
                case '0':
                ...
                case '2':
                    ...
                    response+="¿Que quieres hacer?: "
                    response+="A. Dejarle todo a la policía."
                    response+="B. Tomar venganza tú mismo." 
                case '3':
                    #Vas a beber: 0011333
                ...
                case '5':
                    ...
                    response+="¿Que quieres hacer?: "
                    response+="A. Atacar a #$%."
                    response+="B. Exponerlo a los demás reclusos." 
                case '6':
                    ...
                    response+="¿Que quieres hacer?: "
                    response+="A. Ir a la policía."
                    response+="B. Tomar una vida en venganza de la de tu hija." 
                case '7':
        ...
        case 8:
            match value:
                ...
                case '3':
                    ...
                    response+="¿Que quieres hacer?: "
                    response+="A. Incendiar la casa."
                    response+="B. Irrumpir en ella." 
                case '4':
                ...
                case '7':
                    ...
                    response+="¿Que quieres hacer?: "
                    response+="A. Tomar la vida de #$%."
                    response+="B. Dejarle vivir." 
                case '8':
                ...
                case 'a':
                    ...
                    response+="¿Que quieres hacer?: "
                    response+="A. Abalanzarte ya mismo."
                    response+="B. Esperar la oportunidad de hacer un ataque sorpresa." 
                case 'b':
                    ...
                    response+="¿Que quieres hacer?: "
                    response+="A. Prenderle fuego a la casa."
                    response+="B. Correr directo a la policía." 
        case 9:
            match value:
                case '0':
